            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-3">
              ...
              {initialData ? (
                <button
                  ...
                  className="w-full min-h-[48px] mt-4 bg-blue-600 hover:bg-blue-700 disabled:opacity-60 disabled:cursor-not-allowed text-white font-semibold rounded-lg transition-colors cursor-pointer text-lg shadow-sm flex items-center justify-center gap-2"
                >
                  {isSubmitting ? (
                ...
                <div className="flex gap-2 mt-4">
                  <button
                    ...
                    className="flex-[2] min-h-[48px] bg-blue-600 hover:bg-blue-700 disabled:opacity-60 disabled:cursor-not-allowed text-white font-semibold rounded-lg transition-colors cursor-pointer shadow-sm text-sm flex items-center justify-center gap-2"
                  >
                  ...
                  <button
                    ...
                    className="flex-[1.5] min-h-[48px] bg-slate-200 dark:bg-slate-800 hover:bg-slate-300 dark:hover:bg-slate-700 disabled:opacity-60 disabled:cursor-not-allowed text-slate-900 dark:text-white font-semibold rounded-lg transition-colors cursor-pointer shadow-sm text-sm flex items-center justify-center gap-2"
                  >
